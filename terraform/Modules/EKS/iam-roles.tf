...
resource "aws_iam_role" "eks_worker_node_group" {
...
resource "aws_iam_role_policy_attachment" "AmazonEKSWorkerNodePolicy" {
  ...
  role       = aws_iam_role.eks_worker_node_group.name
}
...
locals {
  oidc_provider = split("https://", aws_eks_cluster.this.identity[0].oidc[0].issuer)[1]
}
